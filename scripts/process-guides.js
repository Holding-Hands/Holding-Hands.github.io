...
// Guide metadata
const guides = [
  { id: 'chenghuangge', fileName: 'public/guides/杭州景点/城隍阁.md', title: '城隍阁', category: '杭州景点', location: '杭州', description: '城隍阁景区位于吴山之巅，是杭州的标志性建筑之一。登阁可俯瞰西湖全景和杭城美景。' },
  { id: 'leifengta', fileName: 'public/guides/杭州景点/雷峰塔.md', title: '雷峰塔', category: '杭州景点', location: '杭州', description: '雷峰塔位于西湖南岸，因白娘子传说而闻名。现塔为2002年重建，融合了现代科技与古典美学。' },
  { id: 'feilaifeng', fileName: 'public/guides/杭州景点/飞来峰.md', title: '飞来峰', category: '杭州景点', location: '杭州', description: '飞来峰位于灵隐寺旁，以石窟造像和摩崖石刻著称，是中国南方古代石窟艺术的瑰宝。' },
  { id: 'huxueyanguju', fileName: 'public/guides/杭州景点/胡雪岩故居.md', title: '胡雪岩故居', category: '杭州景点', location: '杭州', description: '胡雪岩故居是清末红顶商人胡雪岩的宅邸，展现了晚清江南豪宅的建筑风格和商业文化。' },
  { id: 'zhuozhengyuan', fileName: 'public/guides/苏州园林/拙政园.md', title: '拙政园', category: '苏州园林', location: '苏州', description: '拙政园是中国四大名园之一，以水景见长，是江南古典园林的代表作品。' },
  { id: 'shizilin', fileName: 'public/guides/苏州园林/狮子林.md', title: '狮子林', category: '苏州园林', location: '苏州', description: '狮子林以假山著称，园内石峰林立，形态各异，宛如群狮起舞。' },
  { id: 'xiaolianzhuan', fileName: 'public/guides/湖州景点/小莲庄.md', title: '小莲庄', category: '湖州景点', location: '湖州', description: '小莲庄是清末光禄大夫刘镛的私家园林，以荷花池和家族祠堂闻名。' },
  { id: 'zhangshimingjiuzhai', fileName: 'public/guides/湖州景点/张石铭旧宅.md', title: '张石铭旧宅', category: '湖州景点', location: '湖州', description: '张石铭旧宅是江南罕见的中西合璧建筑群，展现了清末民初的建筑艺术。' },
  { id: 'yuefei', fileName: 'public/guides/历史人物/岳飞.md', title: '岳飞', category: '历史人物', location: '杭州', description: '南宋抗金名将岳飞的生平事迹，精忠报国的民族英雄。' },
